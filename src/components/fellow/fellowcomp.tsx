        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="w-[300px] h-[450px] mx-auto flex items-center justify-center">
                <Image
