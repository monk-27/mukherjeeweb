  ...
  return (
    <section className="max-w-7xl mx-auto py-16 px-4 xl:px-0 text-center">
      ...
      >
        {images.map((image, index) => (
          ...
          >
            <Image
              ...
              width={500}
              height={500}
              className="w-full h-full object-cover rounded-lg max-h-96 object-top filter grayscale transition duration-300 group-hover:grayscale-0"
            />
            ...
            >
              <div className="bg-white text-black px-4 py-2 rounded-lg w-full">
                {image.title}
              </div>
            </motion.div>
          </motion.div>
        ...
        >
          <motion.div
            className="relative mx-auto  max-w-full max-h-[90vh] flex items-center gap-4 bg-white p-12 rounded-lg"
